...
func (p *UserMgr) getUser(conn redis.Conn, id int) (user *proto.User, err error) {
...
func (p *UserMgr) Login(id int, passwd string) (user *proto.User, err error) {
	conn := p.pool.Get()
	defer conn.Close()
